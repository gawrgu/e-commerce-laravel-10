                            ...
                            <div class="cart-item">
                                <div class="row">
                                        ...
                                        <a
                                            ...
                                            <label class="product-name">
                                                <img src="{{ asset('storage/uploads/product/' . $value->product->productImages[0]->image) }}"
                                                    style="width: 50px; height: 50px" alt="{{ $value->product->name }}">
                                                {{ $value->product->name }}
                                            </label>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12 my-auto">
                                        <div class="remove">
                                            <button type="button" wire:click="removeWishlistItem({{ $value->id }})"
                                                class="btn btn-danger btn-sm">
                                                <span wire:loading.remove
                                                    wire:target="removeWishlistItem({{ $value->id }})">
