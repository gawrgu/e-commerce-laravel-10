        ...
        <div class="container">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            <h4 class="text-primary">
                                Item Total Amount :
                                <span class="float-end">IDR {{ number_format($this->totalProductAmont) }}</span>
                            </h4>
                            <hr>
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    <h5>No items card to check-out!</h5>
                    <a href="{{ url('categories') }}" class="btn btn-warning">Shop Now!</a>
                </div>
            @endif
