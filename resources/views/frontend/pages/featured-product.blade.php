            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="product-card">
                            <div class="product-card-img">
                                ...
                                @else
                                    <a href="{{ url('categories/' . $item->categories->slug . '/' . $item->slug) }}">
                                        <img src="{{ asset('storage/uploads/default.png') }}" alt="{{ $item->name }}">
                                    </a>
                                @endif
                            </div>
                ...
                @empty
                    <div class="col-md-12 p-2">
                        <h4>No featured product avaible.</h4>
                    </div>
                @endforelse

                <div class="text-center">
                    <a href="{{ url('categories') }}" class="btn btn-outline-info px-3"><i class="fa fa-shopping-cart">
                            Shop
                            Now</i></a>
                </div>
